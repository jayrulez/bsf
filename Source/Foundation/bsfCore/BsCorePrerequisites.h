...
#define CORE_OBJECT_NEW_FORWARD_DECLARE_STRUCT(TYPE)		\
	...
	CORE_OBJECT_NEW_FORWARD_DECLARE(Pass)
	CORE_OBJECT_NEW_FORWARD_DECLARE(Technique)
	CORE_OBJECT_NEW_FORWARD_DECLARE(Shader)
	CORE_OBJECT_NEW_FORWARD_DECLARE(Material)
	...
	CORE_OBJECT_NEW_FORWARD_DECLARE(Viewport)
	CORE_OBJECT_NEW_FORWARD_DECLARE(VertexDeclaration)
	...
	CORE_OBJECT_NEW_FORWARD_DECLARE(MaterialParams)
	CORE_OBJECT_FORWARD_DECLARE(Light)
	CORE_OBJECT_NEW_FORWARD_DECLARE(Camera)
	CORE_OBJECT_NEW_FORWARD_DECLARE(Renderable)
	...
	CORE_OBJECT_NEW_FORWARD_DECLARE_STRUCT(DepthOfFieldSettings)
	CORE_OBJECT_NEW_FORWARD_DECLARE_STRUCT(ChromaticAberrationSettings)
	CORE_OBJECT_NEW_FORWARD_DECLARE_STRUCT(RenderSettings)
