...
namespace bs
{
	...
	public:
		 ...
		 */
		virtual void setFullscreen(UINT32 width, UINT32 height, float refreshRate = 60.0f, UINT32 monitorIdx = 0) = 0;
		 ...
		 */
		virtual void setFullscreen(const VideoMode& videoMode) = 0;
		 ...
		 */
		virtual void setWindowed(UINT32 width, UINT32 height) = 0;
