...
#include "BsNetworkPrerequisites.h"
...
namespace bs
{
	 ...
	 * connected peers.
	 */
	class BS_NETWORK_EXPORT NetworkPeer
	{
	public:
	 ...
	 */
	class BS_NETWORK_EXPORT Network : public Module<Network>
	{
	public:
		// TODO- Doc
