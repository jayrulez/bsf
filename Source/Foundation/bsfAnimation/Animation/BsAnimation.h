...
namespace bs
{
	...
	struct BS_ANIMATION_EXPORT BS_SCRIPT_EXPORT(pl:true,m:Animation) BlendClipInfo
	{
	...
	struct BS_ANIMATION_EXPORT BS_SCRIPT_EXPORT(pl:true,m:Animation) Blend1DInfo
	{
	 ...
	 */
	class BS_ANIMATION_EXPORT Animation : public CoreObject, public IResourceListener
	{
	public:
		~Animation();
