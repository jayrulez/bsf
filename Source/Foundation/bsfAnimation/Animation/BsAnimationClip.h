...
namespace bs
{
	...
	struct BS_ANIMATION_EXPORT BS_SCRIPT_EXPORT(m:Animation) AnimationCurves
	{
		BS_SCRIPT_EXPORT()
	 ...
	 */
	class BS_ANIMATION_EXPORT BS_SCRIPT_EXPORT(m:Animation) AnimationClip : public Resource
	{
	public:
