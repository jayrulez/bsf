...
#include "BsAnimationPrerequisites.h"
...
namespace bs
{
	...
	struct BS_ANIMATION_EXPORT MorphVertex
	{
		MorphVertex() = default;
	 ...
	 * @endscript
	 */
	class BS_ANIMATION_EXPORT BS_SCRIPT_EXPORT(m:Animation) MorphShape : public IReflectable
	{
	public:
	 ...
	 */
	class BS_ANIMATION_EXPORT BS_SCRIPT_EXPORT(m:Animation) MorphChannel : public IReflectable
	{
	public:
	 ...
	 * on some weight.
	 */
	class BS_ANIMATION_EXPORT BS_SCRIPT_EXPORT(m:Animation) MorphShapes : public IReflectable // Note: Must be immutable in order to be usable on multiple threads
	{
	public:
