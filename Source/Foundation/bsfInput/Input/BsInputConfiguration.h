...
#include "BsInputPrerequisites.h"
...
namespace bs
{
	 ...
	 */
	struct BS_INPUT_EXPORT VIRTUAL_BUTTON_DESC
	{
	 ...
	 */
	struct BS_INPUT_EXPORT VIRTUAL_AXIS_DESC
	{
	 ...
	 */
	class BS_INPUT_EXPORT VirtualButton
	{
	public:
	 ...
	 */
	class BS_INPUT_EXPORT VirtualAxis
	{
	public:
		VirtualAxis() = default;
	...
	class BS_INPUT_EXPORT InputConfiguration
	{
