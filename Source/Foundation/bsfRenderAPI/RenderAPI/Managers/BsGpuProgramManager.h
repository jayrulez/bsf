...
namespace bs
{
	 ...
	 */
	class BS_RENDERAPI_EXPORT GpuProgramManager : public Module<GpuProgramManager>
	{
	public:
	...
	class BS_RENDERAPI_EXPORT GpuProgramFactory
	{
	public:
	...
	class BS_RENDERAPI_EXPORT NullProgramFactory : public GpuProgramFactory
	{
	public:
