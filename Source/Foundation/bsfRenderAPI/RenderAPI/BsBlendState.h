...
namespace bs
{
	 ...
	 * @see		BlendState
	 */
	struct BS_RENDERAPI_EXPORT RENDER_TARGET_BLEND_STATE_DESC
	{
	...
	struct BS_RENDERAPI_EXPORT BLEND_STATE_DESC
	{
	...
	class BS_RENDERAPI_EXPORT BlendProperties
	{
	public:
	 ...
	 */
	class BS_RENDERAPI_EXPORT BlendState : public IReflectable, public CoreObject
	{
	public:
		virtual ~BlendState();
	 ...
	 * @note	Core thread.
	 */
	class BS_RENDERAPI_EXPORT BlendState : public CoreObject
	{
	public:
		virtual ~BlendState();
