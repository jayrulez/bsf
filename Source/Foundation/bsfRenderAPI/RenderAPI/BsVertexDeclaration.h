...
namespace bs
{
	...
	class BS_RENDERAPI_EXPORT VertexElement
	{
	public:
	...
	class BS_RENDERAPI_EXPORT VertexDeclarationProperties
	{
	public:
	 ...
	 * @note	Sim thread.
	 */
	class BS_RENDERAPI_EXPORT VertexDeclaration : public IReflectable, public CoreObject
	{
	public:
	...
	BS_RENDERAPI_EXPORT String toString(const VertexElementSemantic& val);
	 ...
	 * @note	Core thread.
	 */
	class BS_RENDERAPI_EXPORT VertexDeclaration : public CoreObject
	{
	public:
