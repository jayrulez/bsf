...
namespace bs
{
	...
	struct BS_RENDERAPI_EXPORT BS_SCRIPT_EXPORT(m:RenderAPI,pl:true,api:bsf) RENDER_WINDOW_DESC
	{
	...
	class BS_RENDERAPI_EXPORT RenderWindowProperties : public RenderTargetProperties
	{
	public:
	 ...
	 */
	class BS_RENDERAPI_EXPORT RenderWindow : public RenderTarget
	{
	public:
