...
namespace bs
{
	 ...
	 */
	class BS_RENDERAPI_EXPORT GpuProgram : public IReflectable, public CoreObject
	{
	public:
	 ...
	 */
	struct BS_RENDERAPI_EXPORT GpuProgramBytecode : IReflectable
	{
		~GpuProgramBytecode();
	 ...
	 */
	class BS_RENDERAPI_EXPORT GpuProgram : public CoreObject
	{
	public:
		virtual ~GpuProgram();
