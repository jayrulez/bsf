...
namespace bs
{
	 ...
	 * properties.
	 */
	class BS_RENDERAPI_EXPORT GpuBufferProperties
	{
	public:
	 ...
	 */
	class BS_RENDERAPI_EXPORT GpuBuffer : public CoreObject
	{
	public:
	 ...
	 */
	class BS_RENDERAPI_EXPORT GpuBuffer : public CoreObject, public HardwareBuffer
	{
	public:
		virtual ~GpuBuffer();
