...
namespace bs
{
	...
	struct BS_RENDERAPI_EXPORT RENDER_TEXTURE_DESC
	{
	...
	class BS_RENDERAPI_EXPORT RenderTextureProperties : public RenderTargetProperties
	{
	public:
	 ...
	 */
	class BS_RENDERAPI_EXPORT BS_SCRIPT_EXPORT(m:Rendering) RenderTexture : public RenderTarget
	{
	public:
	 ...
	 * @note	Core thread only.
	 */
	class BS_RENDERAPI_EXPORT RenderTexture : public RenderTarget
	{
	public:
