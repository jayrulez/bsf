...
namespace bs
{
	...
	class BS_RENDERAPI_EXPORT ViewportBase
	{
	public:
	 ...
	 */
	class BS_RENDERAPI_EXPORT BS_SCRIPT_EXPORT(m:Rendering) Viewport : public IReflectable, public CoreObject, public TViewport<false>
	{
	public:
	...
	/** @copydoc bs::Viewport */
	class BS_RENDERAPI_EXPORT Viewport : public CoreObject, public TViewport<true>
	{
	public:
