...
namespace bs
{
	...
	class BS_RENDERAPI_EXPORT VertexBufferProperties
	{
	public:
	...
	class BS_RENDERAPI_EXPORT VertexBuffer : public CoreObject
	{
	public:
	...
	class BS_RENDERAPI_EXPORT VertexBuffer : public CoreObject, public HardwareBuffer
	{
	public:
