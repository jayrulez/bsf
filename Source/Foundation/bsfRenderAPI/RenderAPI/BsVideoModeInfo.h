...
namespace bs
{
	 ...
	 * monitor.
	 */
	class BS_RENDERAPI_EXPORT BS_SCRIPT_EXPORT(m:RenderAPI,pl:true,api:bsf) VideoMode
	{
	public:
		VideoMode() = default;
	...
	class BS_RENDERAPI_EXPORT VideoOutputInfo
	{
	public:
	...
	class BS_RENDERAPI_EXPORT VideoModeInfo
	{
	public:
