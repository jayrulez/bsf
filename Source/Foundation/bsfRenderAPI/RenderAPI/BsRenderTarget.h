...
namespace bs
{
	...
	struct BS_RENDERAPI_EXPORT RENDER_SURFACE_DESC
	{
		RENDER_SURFACE_DESC() { }
	...
	class BS_RENDERAPI_EXPORT RenderTargetProperties
	{
	public:
	 ...
	 */
	class BS_RENDERAPI_EXPORT BS_SCRIPT_EXPORT(m:Rendering) RenderTarget : public IReflectable, public CoreObject
	{
	public:
		RenderTarget();
	 ...
	 */
	class BS_RENDERAPI_EXPORT RenderTarget : public CoreObject
	{
	public:
