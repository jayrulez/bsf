...
namespace bs
{
	...
	struct TEXTURE_COPY_DESC
	{
		...
		BS_RENDERAPI_EXPORT static TEXTURE_COPY_DESC DEFAULT;
	};

	/** Properties of a Texture. Shared between sim and core thread versions of a Texture. */
	class BS_RENDERAPI_EXPORT TextureProperties
	{
	public:
	 ...
	 * @note	Sim thread.
	 */
	class BS_RENDERAPI_EXPORT BS_SCRIPT_EXPORT(m:Rendering) Texture : public Resource
	{
	public:
		/**
	 ...
	 * @note	Core thread.
	 */
	class BS_RENDERAPI_EXPORT Texture : public CoreObject
	{
	public:
