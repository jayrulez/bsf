...
namespace bs
{
	...
	class BS_RENDERAPI_EXPORT IndexBufferProperties
	{
	public:
	...
	class BS_RENDERAPI_EXPORT IndexBuffer : public CoreObject
	{
	public:
		virtual ~IndexBuffer() { }
	...
	class BS_RENDERAPI_EXPORT IndexBuffer : public CoreObject, public HardwareBuffer
	{
	public:
