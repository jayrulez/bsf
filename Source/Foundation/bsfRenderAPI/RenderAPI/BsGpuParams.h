...
namespace bs
{
	...
	class BS_RENDERAPI_EXPORT GpuParamsBase
	{
	public:
	...
	template <bool Core>
	class BS_RENDERAPI_EXPORT TGpuParams : public GpuParamsBase
	{
	public:
	 ...
	 */
	class BS_RENDERAPI_EXPORT GpuParams : public CoreObject, public TGpuParams<false>, public IResourceListener
	{
	public:
		~GpuParams() { }
	 ...
	 */
	class BS_RENDERAPI_EXPORT GpuParams : public CoreObject, public TGpuParams<true>
	{
	public:
		virtual ~GpuParams() { }
