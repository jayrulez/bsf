...
namespace bs
{
	...
	struct BS_RENDERAPI_EXPORT RASTERIZER_STATE_DESC
	{
	...
	class BS_RENDERAPI_EXPORT RasterizerProperties
	{
	public:
	 ...
	 */
	class BS_RENDERAPI_EXPORT RasterizerState : public IReflectable, public CoreObject
	{
	public:
	 ...
	 * @note	Core thread.
	 */
	class BS_RENDERAPI_EXPORT RasterizerState : public CoreObject
	{
	public:
		virtual ~RasterizerState();
