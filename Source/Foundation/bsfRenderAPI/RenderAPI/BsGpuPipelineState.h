...
#include "BsRenderAPIPrerequisites.h"
...
namespace bs
{
	 ...
	 */
	template<bool Core>
	class BS_RENDERAPI_EXPORT TGraphicsPipelineState
	{
	public:
	 ...
	 */
	template<bool Core>
	class BS_RENDERAPI_EXPORT TComputePipelineState
	{
	public:
		using GpuProgramType = SPtr<CoreVariantType<GpuProgram, Core>>;
		using GpuPipelineParamInfoType = typename TGpuPipelineStateTypes<Core>::GpuPipelineParamInfoType;
	 ...
	 */
	class BS_RENDERAPI_EXPORT GraphicsPipelineState : public CoreObject, public TGraphicsPipelineState<false>
	{
	public:
	 ...
	 * use.
	 */
	class BS_RENDERAPI_EXPORT ComputePipelineState : public CoreObject, public TComputePipelineState<false>
	{
	public:
	...
	class BS_RENDERAPI_EXPORT GraphicsPipelineState : public CoreObject, public TGraphicsPipelineState<true>
	{
	public:
	...
	class BS_RENDERAPI_EXPORT ComputePipelineState : public CoreObject, public TComputePipelineState<true>
	{
	public:
