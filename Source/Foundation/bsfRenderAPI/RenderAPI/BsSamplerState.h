...
namespace bs
{
	 ...
	 * @see		SamplerState
	 */
	struct BS_RENDERAPI_EXPORT SAMPLER_STATE_DESC
	{
		SAMPLER_STATE_DESC() { };
	...
	class BS_RENDERAPI_EXPORT SamplerProperties
	{
	public:
	 ...
	 * Sim thread.
	 */
	class BS_RENDERAPI_EXPORT SamplerState : public IReflectable, public CoreObject
	{
	public:
	 ...
	 * @note	Core thread.
	 */
	class BS_RENDERAPI_EXPORT SamplerState : public CoreObject
	{
	public:
