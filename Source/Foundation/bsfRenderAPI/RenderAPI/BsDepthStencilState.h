...
namespace bs
{
	 ...
	 */
	struct BS_RENDERAPI_EXPORT DEPTH_STENCIL_STATE_DESC
	{
	...
	class BS_RENDERAPI_EXPORT DepthStencilProperties
	{
	public:
	 ...
	 */
	class BS_RENDERAPI_EXPORT DepthStencilState : public IReflectable, public CoreObject
	{
	public:
	 ...
	 * @note	Core thread.
	 */
	class BS_RENDERAPI_EXPORT DepthStencilState : public CoreObject
	{
	public:
