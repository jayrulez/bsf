...
namespace bs
{
	...
	class BS_RENDERAPI_EXPORT TGpuDataParam
	{
	private:
	...
	template<bool Core>
	class BS_RENDERAPI_EXPORT TGpuParamStruct
	{
	public:
		using GpuParamBufferType = SPtr<CoreVariantType<GpuParamBlockBuffer, Core>>;
		using GpuParamsType = SPtr<CoreVariantType<GpuParams, Core>>;
	...
	/** @copydoc TGpuDataParam */
	template<bool Core>
	class BS_RENDERAPI_EXPORT TGpuParamTexture
	{
	private:
	...
	/** @copydoc TGpuDataParam */
	template<bool Core>
	class BS_RENDERAPI_EXPORT TGpuParamLoadStoreTexture
	{
	private:
		friend class GpuParams;
		friend class ct::GpuParams;
	...
	/** @copydoc TGpuDataParam */
	template<bool Core>
	class BS_RENDERAPI_EXPORT TGpuParamBuffer
	{
	private:
		friend class GpuParams;
		friend class ct::GpuParams;
	...
	/** @copydoc TGpuDataParam */
	template<bool Core>
	class BS_RENDERAPI_EXPORT TGpuParamSampState
	{
	private:
		friend class GpuParams;
		friend class ct::GpuParams;
