...
namespace bs
{
	...
	namespace detail
	{
		...
		template<bool Core>
		class BS_PARTICLES_EXPORT TVectorField
		{
		public:
	 ...
	 */
	class BS_PARTICLES_EXPORT BS_SCRIPT_EXPORT(m:Particles) VectorField : public Resource, public detail::TVectorField<false>
	{
	public:
	...
	namespace ct
	{
		...
		class BS_PARTICLES_EXPORT VectorField : public CoreObject, public detail::TVectorField<true>
		{
		public:
	...
	class BS_PARTICLES_EXPORT FGAImporter : public SpecificImporter
	{
	public:
