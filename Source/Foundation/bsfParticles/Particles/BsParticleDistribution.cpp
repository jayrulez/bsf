...
namespace bs
{
	...
	template struct BS_PARTICLES_EXPORT TColorDistribution<ColorGradient>;
	template struct BS_PARTICLES_EXPORT TColorDistribution<ColorGradientHDR>;
	...
	template struct BS_PARTICLES_EXPORT TDistribution<float>;
	template struct BS_PARTICLES_EXPORT TDistribution<Vector3>;
	template struct BS_PARTICLES_EXPORT TDistribution<Vector2>;
}
