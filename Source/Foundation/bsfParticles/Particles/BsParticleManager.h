...
namespace bs
{
	 ...
	 * rendering modes.
	 */
	struct BS_PARTICLES_EXPORT ParticleRenderData
	{
	 ...
	 */
	struct BS_PARTICLES_EXPORT ParticleBillboardRenderData : ParticleRenderData
	{
	 ...
	 * can be used for quickly initializing a texture.
	 */
	struct BS_PARTICLES_EXPORT ParticleMeshRenderData : ParticleRenderData
	{
	...
	struct BS_PARTICLES_EXPORT ParticleGPUSimulationData
	{
	...
	class BS_PARTICLES_EXPORT ParticleManager final : public Module<ParticleManager>
	{
		struct Members;
	public:
		ParticleManager();
