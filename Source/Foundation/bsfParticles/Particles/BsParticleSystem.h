...
namespace bs
{
	...
	struct BS_PARTICLES_EXPORT BS_SCRIPT_EXPORT(m:Particles) ParticleDepthCollisionSettings : IReflectable
	{
		BS_SCRIPT_EXPORT()
	...
	struct BS_PARTICLES_EXPORT BS_SCRIPT_EXPORT(m:Particles)
	 ...
	 */
	class BS_PARTICLES_EXPORT ParticleSystem final : public IReflectable, public CoreObject, public SceneActor, public INonCopyable
	{
	public:
	...
	namespace ct
	{
		...
		class BS_PARTICLES_EXPORT ParticleSystem final : public CoreObject, public SceneActor, public INonCopyable
		{
		public:
			~ParticleSystem();
