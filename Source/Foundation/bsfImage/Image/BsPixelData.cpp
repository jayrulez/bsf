...
namespace bs
{
	...
	template BS_IMAGE_EXPORT void PixelData::setColorsInternal(Color* const &, UINT32);
	template BS_IMAGE_EXPORT void PixelData::setColorsInternal(const Vector<Color>&, UINT32);
