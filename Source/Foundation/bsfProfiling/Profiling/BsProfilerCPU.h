...
#include "BsProfilingPrerequisites.h"
...
namespace bs
{
	 ...
	 */
	class BS_PROFILING_EXPORT ProfilerCPU : public Module<ProfilerCPU>
	{
	...
	struct BS_PROFILING_EXPORT CPUProfilerBasicSamplingEntry
	{
		struct BS_PROFILING_EXPORT Data
		{
			Data() = default;
	 ...
	 * information.
	 */
	struct BS_PROFILING_EXPORT CPUProfilerPreciseSamplingEntry
	{
		struct BS_PROFILING_EXPORT Data
		{
			Data() = default;
	...
	class BS_PROFILING_EXPORT CPUProfilerReport
	{
	public:
	...
	BS_PROFILING_EXPORT ProfilerCPU& gProfilerCPU();
