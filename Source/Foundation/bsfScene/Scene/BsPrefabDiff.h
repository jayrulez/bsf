...
namespace bs
{
	 ...
	 * @see		PrefabDiff
	 */
	struct BS_SCENE_EXPORT PrefabComponentDiff : public IReflectable
	{
		INT32 id;
	 ...
	 * @see		PrefabDiff
	 */
	struct BS_SCENE_EXPORT PrefabObjectDiff : public IReflectable
	{
		PrefabObjectDiff() { }
	 ...
	 */
	class BS_SCENE_EXPORT PrefabDiff : public IReflectable
	{
	public:
		/**
