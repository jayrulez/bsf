...
namespace bs
{
	...
	class BS_SCENE_EXPORT BS_SCRIPT_EXPORT(m:Scene) SceneInstance
	{
	 ...
	 */
	class BS_SCENE_EXPORT SceneManager : public Module<SceneManager>
	{
	public:
		SceneManager();
		~SceneManager();
	...
	BS_SCENE_EXPORT SceneManager& gSceneManager();
