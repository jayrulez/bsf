...
namespace bs
{
	/** @addtogroup Resources-Runtime-Internal
	 *  @{
	 */

	class GUIElementStyleLoader;

	/**	Provides various methods commonly used for importing and managing builtin resources. */
	class BS_RUNTIME_EXPORT BuiltinResourcesHelper
	{
	public:
	 ...
	 */
	class BS_RUNTIME_EXPORT GUIElementStyleLoader
	{
	public:
	...
	class BS_RUNTIME_EXPORT BuiltinResourceGUIElementStyleLoader final : public GUIElementStyleLoader
	{
	public:
