...
namespace bs
{
	 ...
	 * language.
	 */
	class BS_LOCALIZATION_EXPORT BS_SCRIPT_EXPORT(n:StringTables,m:Localization) StringTableManager : public Module<StringTableManager>
	{
	public:
	...
	BS_LOCALIZATION_EXPORT StringTableManager& gStringTableManager();
