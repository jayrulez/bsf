...
namespace bs
{
	...
	class BS_GUI_EXPORT GUISlider : public GUIElementContainer
	{
	public:
	...
	class BS_GUI_EXPORT GUISliderHorz : public GUISlider
	{
	public:
	...
	class BS_GUI_EXPORT GUISliderVert : public GUISlider
	{
	public:
		/** Returns type name of the GUI element used for finding GUI element styles.  */
		static const String& getGUITypeName();
