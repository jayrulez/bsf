...
namespace bs
{
	...
	struct BS_TEXT_EXPORT BS_SCRIPT_EXPORT(m:GUI_Engine) FontBitmap : public IReflectable
	{
	 ...
	 */
	class BS_TEXT_EXPORT BS_SCRIPT_EXPORT(m:GUI_Engine) Font : public Resource
	{
	public:
