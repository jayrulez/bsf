...
namespace bs
{
	...
	class BS_TEXT_EXPORT FontBitmapRTTI : public RTTIType<FontBitmap, IReflectable, FontBitmapRTTI>
	{
	private:
	...
	class BS_TEXT_EXPORT FontRTTI : public RTTIType<Font, Resource, FontRTTI>
	{
	private:
