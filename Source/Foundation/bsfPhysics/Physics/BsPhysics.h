...
#include "BsPhysicsPrerequisites.h"
...
namespace bs
{
	...
	class BS_PHYSICS_EXPORT BS_SCRIPT_EXPORT(m:Physics) Physics : public Module<Physics>
	{
	public:
	...
	BS_PHYSICS_EXPORT Physics& gPhysics();
	 ...
	 */
	class BS_PHYSICS_EXPORT BS_SCRIPT_EXPORT(m:Physics) PhysicsScene
	{
	public:
		/******************************************************************************************************************/
		/************************************************* QUERIES ********************************************************/
