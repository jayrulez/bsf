...
#include "BsPlatformPrerequisites.h"
...
namespace bs
{
	...
	struct BS_PLATFORM_EXPORT OSPointerButtonStates
	{
	...
	struct BS_PLATFORM_EXPORT NonClientResizeArea
	{
	...
	struct BS_PLATFORM_EXPORT WindowNonClientAreaData
	{
	...
	class BS_PLATFORM_EXPORT Platform
	{
	public:
		struct Pimpl;
