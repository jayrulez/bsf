...
namespace bs
{
	...
	class BS_2D_EXPORT SpriteImageMaterial : public SpriteMaterial
	{
	public:
	...
	class BS_2D_EXPORT SpriteTextMaterial : public SpriteMaterial
	{
	public:
		SpriteTextMaterial();
	};
	...
	class BS_2D_EXPORT SpriteLineMaterial : public SpriteMaterial
	{
	public:
		SpriteLineMaterial();
	};
