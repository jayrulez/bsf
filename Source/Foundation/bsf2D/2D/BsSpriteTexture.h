...
namespace bs
{
	...
	class BS_2D_EXPORT SpriteTextureBase
	{
	public:
	...
	template<bool Core>
	class BS_2D_EXPORT TSpriteTexture : public SpriteTextureBase
	{
	public:
	 ...
	 */
	class BS_2D_EXPORT BS_SCRIPT_EXPORT(m:Rendering) SpriteTexture : public Resource, public TSpriteTexture<false>
	{
	public:
	...
	namespace ct
	{
		 ...
		 * @note	Core thread.
		 */
		class BS_2D_EXPORT SpriteTexture : public CoreObject, public TSpriteTexture<true>
		{
		public:
			/**	Determines the internal texture that the sprite texture references. */
