...
namespace bs
{
	...
	struct BS_RESOURCES_EXPORT ResourceHandleData
	{
		SPtr<Resource> mPtr;
		UUID mUUID;
	 ...
	 */
	class BS_RESOURCES_EXPORT ResourceHandleBase : public IReflectable
	{
	public:
		/**
	...
	class BS_RESOURCES_EXPORT TResourceHandleBase : public ResourceHandleBase
	{ };

	/**	Specialization of TResourceHandleBase for weak handles. Weak handles do no reference counting. */
	template<>
	class BS_RESOURCES_EXPORT TResourceHandleBase<true> : public ResourceHandleBase
	{
	protected:
		void addRef() { };
		void releaseRef() { };
	...
	template<>
	class BS_RESOURCES_EXPORT TResourceHandleBase<false> : public ResourceHandleBase
	{
	protected:
		void addRef()
		{
