...
namespace bs
{
		...
		std::atomic<float>& progress)
	{
		...
		//CoreSerializationContext serzContext; // todo: robert
		SerializationContext serzContext;
	...
	void Resources::_save(const SPtr<Resource>& resource, const Path& filePath, bool compress)
	{
		...
		Vector<ResourceDependency> dependencyList = ResourceUtility::findResourceDependencies(*resource);
	...
	BS_RESOURCES_EXPORT Resources& gResources()
	{
