...
namespace bs
{
	...
	class BS_RENDERER_EXPORT DecalBase : public SceneActor
	{
	public:
		DecalBase();
	...
	template<bool Core>
	class BS_RENDERER_EXPORT TDecal : public DecalBase
	{
	public:
	 ...
	 */
	class BS_RENDERER_EXPORT Decal : public IReflectable, public CoreObject, public TDecal<false>
	{
	public:
	...
	class BS_RENDERER_EXPORT Decal : public CoreObject, public TDecal<true>
	{
	public:
		~Decal();
