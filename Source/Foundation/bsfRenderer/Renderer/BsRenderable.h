...
namespace bs
{
	 ...
	 */
	template<bool Core>
	class BS_RENDERER_EXPORT TRenderable : public SceneActor
	{
	...
	/** @copydoc TRenderable */
	class BS_RENDERER_EXPORT Renderable : public IReflectable, public CoreObject, public TRenderable<false>, public IResourceListener
	{
	public:
	...
	{
	/** @copydoc TRenderable */
	class BS_RENDERER_EXPORT Renderable : public CoreObject, public TRenderable<true>
	{
	public:
		~Renderable();
