...
namespace bs
{
	...
	class BS_RENDERER_EXPORT CameraBase : public SceneActor
	{
	public:
	...
	template<bool Core>
	class BS_RENDERER_EXPORT TCamera : public CameraBase
	{
	 ...
	 */
	class BS_RENDERER_EXPORT Camera : public IReflectable, public CoreObject, public TCamera<false>
	{
	public:
		/**
	...
	{
	/** @copydoc bs::Camera */
	class BS_RENDERER_EXPORT Camera : public CoreObject, public TCamera<true>
	{
	public:
		~Camera();
