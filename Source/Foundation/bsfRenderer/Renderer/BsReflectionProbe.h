...
namespace bs
{
	...
	class BS_RENDERER_EXPORT ReflectionProbeBase : public SceneActor
	{
	public:
	...
	template<bool Core>
	class BS_RENDERER_EXPORT TReflectionProbe : public ReflectionProbeBase
	{
	public:
	 ...
	 */
	class BS_RENDERER_EXPORT ReflectionProbe : public IReflectable, public CoreObject, public TReflectionProbe<false>
	{
	public:
		~ReflectionProbe();
	...
	class BS_RENDERER_EXPORT ReflectionProbe : public CoreObject, public TReflectionProbe<true>
	{
	public:
		~ReflectionProbe();
