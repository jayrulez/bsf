...
namespace bs
{
	...
	class BS_RENDERER_EXPORT LightBase : public SceneActor
	{
	public:
		LightBase();
	...
	class BS_RENDERER_EXPORT Light : public IReflectable, public CoreObject, public LightBase
	{
	public:
	...
	class BS_RENDERER_EXPORT Light : public CoreObject, public LightBase
	{
	public:
		~Light();
