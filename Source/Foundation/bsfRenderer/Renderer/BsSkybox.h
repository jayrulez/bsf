...
namespace bs
{
	...
	class BS_RENDERER_EXPORT SkyboxBase : public SceneActor
	{
	public:
		SkyboxBase() = default;
	...
	template<bool Core>
	class BS_RENDERER_EXPORT TSkybox : public SkyboxBase
	{
	public:
	...
	class BS_RENDERER_EXPORT Skybox : public IReflectable, public CoreObject, public TSkybox<false>
	{
	public:
		~Skybox();
	...
	namespace ct
	{
		...
		class BS_RENDERER_EXPORT Skybox : public CoreObject, public TSkybox<true>
		{
		public:
			~Skybox();
