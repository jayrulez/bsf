...
namespace bs
{
	...
	struct BS_RENDERER_EXPORT RendererOptions
	{
	 ...
	 * way.
	 */
	class BS_RENDERER_EXPORT Renderer
	{
	public:
		Renderer();
	...
	SPtr<Renderer> BS_RENDERER_EXPORT gRenderer();
	 ...
	 */
	class BS_RENDERER_EXPORT RendererTask
	{
