...
namespace bs { namespace ct
{
	...
	struct BS_RENDERER_EXPORT PooledRenderTexture
	{
	...
	struct BS_RENDERER_EXPORT PooledStorageBuffer
	{
	 ...
	 */
	class BS_RENDERER_EXPORT GpuResourcePool : public Module<GpuResourcePool>
	{
	public:
		/**
	...
	struct BS_RENDERER_EXPORT POOLED_RENDER_TEXTURE_DESC
	{
	public:
	...
	struct BS_RENDERER_EXPORT POOLED_STORAGE_BUFFER_DESC
	{
	public:
	...
	BS_RENDERER_EXPORT GpuResourcePool& gGpuResourcePool();
