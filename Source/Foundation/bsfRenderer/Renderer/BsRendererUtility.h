...
namespace bs { namespace ct
{
	...
	class BS_RENDERER_EXPORT BlitMat : public RendererMaterial<BlitMat>
	{
		RMAT_DEF("Blit.bsl");
	...
	class BS_RENDERER_EXPORT CompositeMat : public RendererMaterial<CompositeMat>
	{
	...
	class BS_RENDERER_EXPORT BicubicUpsampleMat : public RendererMaterial<BicubicUpsampleMat>
	{
	...
	class BS_RENDERER_EXPORT ClearMat : public RendererMaterial<ClearMat>
	{
		RMAT_DEF("Clear.bsl");
	 ...
	 */
	class BS_RENDERER_EXPORT RendererUtility : public Module<RendererUtility>
	{
	public:
		RendererUtility();
	...
	BS_RENDERER_EXPORT RendererUtility& gRendererUtility();
