...
namespace bs
{
	 ...
	 */
	class BS_RENDERER_EXPORT LightProbeVolume : public IReflectable, public CoreObject, public SceneActor
	{
	...
	class BS_RENDERER_EXPORT LightProbeVolume : public CoreObject, public SceneActor
	{
	public:
		~LightProbeVolume();
