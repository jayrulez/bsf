...
namespace bs
{
	...
	/**	Holds references to built-in renderer resources. */
	class BS_RENDERER_EXPORT RendererBuiltinResources : public Module<RendererBuiltinResources>
	{
	public:
		RendererBuiltinResources();
		~RendererBuiltinResources() = default;
	...
	/**	Provides easy access to RendererBuiltinResources. */
	BS_RENDERER_EXPORT RendererBuiltinResources& gRendererBuiltinResources();
