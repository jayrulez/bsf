...
namespace bs
{
	 ...
	 */
	 ...
	 /**
	  * Render window implementation for Windows and Diligent.
	  *
	...
	namespace ct
	{
		...
		{
		public:
			Win32RenderWindow(const RENDER_WINDOW_DESC& desc, UINT32 windowId, DiligentRenderAPI& renderAPI);
			~Win32RenderWindow();
