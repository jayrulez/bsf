...
function(add_engine_dependencies2 target_name all_render_api)
	if(${all_render_api})
		if(WIN32)
			add_dependencies(${target_name} bsfD3D11RenderAPI bsfVulkanRenderAPI bsfGLRenderAPI bsfDiligentRenderAPI bsfNullRenderAPI)
		elseif(APPLE)
			add_dependencies(${target_name} bsfGLRenderAPI bsfDiligentRenderAPI bsfNullRenderAPI)
		else()
			add_dependencies(${target_name} bsfVulkanRenderAPI bsfGLRenderAPI bsfDiligentRenderAPI bsfNullRenderAPI)
		endif()
	else()
		...
		elseif(RENDER_API_MODULE MATCHES "DiligentOpenGL" OR RENDER_API_MODULE MATCHES "DiligentOpenGLES" OR RENDER_API_MODULE MATCHES "DiligentD3D11" OR RENDER_API_MODULE MATCHES "DiligentD3D12" OR RENDER_API_MODULE MATCHES "DiligentVulkan")
			add_dependencies(${target_name} bsfDiligentRenderAPI)
		else()
